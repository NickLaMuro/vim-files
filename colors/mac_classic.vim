...
" StatusLine: {{{2
hi StatusLine  guifg=#000000 ctermfg=0 guibg=#C6DEFF ctermbg=189
gui=italic
...
hi gitcommitDiscardedType guifg=#D51015 guibg=#FFFFFF ctermfg=160
ctermbg=15
hi link gitcommitDiscardedFile gitcommitDiscardedType
hi gitcommitUntrackedFile guifg=#6E79F1 guibg=#FFFFFF ctermfg=69
ctermbg=15
" Ruby styles {{{1
